...
const ItemPage = () => {
    console.log("useParams()['food'] = " + useParams()['food']);
    const { data: itemList } = useItem(useParams()['hall'], useParams()['food']);
    ...
    return (
        <BasicLayout>
            ...
            <br />
            <Link to={"/write-review/" + useParams()['hall'] +  "/" + useParams()['food']}>
                <button id="write-review-button"> Write A Review </ button>
            </ Link> 
            <br />
            <ReviewBox rating={rating}/>
            <ReviewBox rating={rating}/>
            <ReviewBox rating={rating}/>
        </BasicLayout>
    );
