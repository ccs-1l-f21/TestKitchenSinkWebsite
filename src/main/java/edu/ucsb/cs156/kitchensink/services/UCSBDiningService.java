...
public class UCSBDiningService {
    ...
    public String getDiningCommonsMealItemsJSON(String date, String diningCommonsCode, String mealCode) throws HttpClientErrorException {

        final String ENDPOINT = "https://api.ucsb.edu/dining/menu/v1/{date}/{diningCommons}/{mealCode}";
        ...
        Map<String, String> uriVariables = Map.of("date", date, "diningCommons", diningCommonsCode, "mealCode", mealCode);
